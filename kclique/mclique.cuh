...
namespace graph
{
    ...
    public:
        ...
        // void find_maximal_clique_node_pivot_async_local_legacy(COOCSRGraph_d<T>& g_dir, COOCSRGraph_d<T>& g_undir,
        //     const size_t nodeOffset = 0, const size_t edgeOffset = 0)
        // {
        //     CUDA_RUNTIME(cudaSetDevice(dev_));
        ...
        //     execKernel((mckernel_node_block_warp_binary_legacy<T, block_size, partitionSize>), grid_block_size, block_size, dev_, false,
        //         g_undir,
        //         g_dir,
        //         g_dir.numNodes,
            ...
            const size_t nodeOffset = 0, const size_t edgeOffset = 0)
        {
            ...
            tmpNode = GPUArray<T> ("Temp Node", gpu, g_undir.numEdges, dev_);
            auto NodeBuffer = GPUArray<T> ("Buffer", gpu, g_undir.numEdges, dev_);
            tmpNode.setAll(0, true);
